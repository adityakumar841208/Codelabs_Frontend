...
const Navbar = () => {
    ...
    return (
        <>
            <div className='h-16 w-full flex justify-around items-center border-customBorder border-b-2 fixed top-0 z-10 px-4 backdrop-blur-sm bg-blue-950 border'>
                {/* Logo */}
                ...
                {/* Search Bar */}
                <div className='flex items-center justify-center rounded-lg border-customBorder border overflow-hidden'>
                    <input
                        type="text"
                        placeholder="Search..."
                        className='h-10 w-32 sm:w-64 px-4 py-2 rounded-l-md focus:outline-none  text-white'
                    />
