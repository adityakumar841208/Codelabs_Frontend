      ...
      >
        <div className="text-center p-8">
          ...
          <p className="text-gray-200 mb-4">
            Discover a world where learning and collaboration come together. At CodeLabs, we help you transform your passion for coding into expertise.
          </p>

          {/* Highlights
          <ul className="text-gray-200 space-y-2 text-sm">
            <li>✨ Learn coding with hands-on courses.</li>
            <li>💡 Solve challenges to sharpen your skills.</li>
            <li>🤝 Engage with like-minded developers worldwide.</li>
            <li>🏆 Build projects and showcase your talent.</li>
          </ul> */}
        </div>
      </div>
